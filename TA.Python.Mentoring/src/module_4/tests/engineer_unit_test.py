...
@pytest.mark.smoke
def test_when_new_engineer_created_then_no_money_and_company_has():
...
def test_when_engineer_joined_new_company_then_they_got_employed():
    ...
    assert test_engineer.company is not None, "Company is not None"
...
@pytest.mark.smoke
@pytest.mark.parametrize("money", [-10, 2000])
